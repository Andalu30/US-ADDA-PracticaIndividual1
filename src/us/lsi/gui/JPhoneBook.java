...
public class JPhoneBook extends JFrame {
	...
	public static void create(final PhoneGroups g, final List<String> names) {
			...
			m_contentPane.setLeftComponent(leftPanel);
			{
				...
				leftPanel.add(groupToolbar, gbc);
				{
					...
					m_newGroupButton.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							JPhoneGroupDialog1 dialog = new JPhoneGroupDialog1(m_names, group);
				...
				}
				{
					...
					m_editGroupButton.addActionListener(new ActionListener() {
						@Override
						public void actionPerformed(ActionEvent e) {
							PhoneGroup group = m_groups.getCategories().get(m_groupList.getSelectedIndex());
							JPhoneGroupDialog1 dialog = new JPhoneGroupDialog1(m_names, group);
							dialog.setLocationRelativeTo(m_contentPane);
							dialog.setVisible(true);
						}
				...
				}
				{
					...
					m_deleteGroupButton.addActionListener(new ActionListener() {
						@Override
						public void actionPerformed(ActionEvent e) {
							m_groups.removeGroup(m_groups.getCategories().get(m_groupList.getSelectedIndex()));
							m_groupList.repaint();
						}
					});
	...
	protected void initDataBindings() {
		...
		JListBinding<PhoneGroup, PhoneGroups, JList> jListBinding = SwingBindings.createJListBinding(UpdateStrategy.READ, m_groups, phoneGroupsBeanProperty, m_groupList);
		//
		...
		JTableBinding<Person, JList, JTable> jTableBinding = SwingBindings.createJTableBinding(UpdateStrategy.READ, m_groupList, jListPersonsBeanProperty, m_personTable);
		//
		...
		AutoBinding<JTable, String, JTextField, String> autoBinding_1 = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, m_personTable, jTableBeanProperty, m_nameTextField, jTextFieldBeanProperty);
		autoBinding_1.bind();
		//
		BeanProperty<JTable, String> jTableBeanProperty_1 = BeanProperty.create("selectedElement.email");
		BeanProperty<JTextField, String> jTextFieldBeanProperty_1 = BeanProperty.create("text");
		AutoBinding<JTable, String, JTextField, String> autoBinding_2 = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, m_personTable, jTableBeanProperty_1, m_emailTextField, jTextFieldBeanProperty_1);
		autoBinding_2.bind();
		//
		BeanProperty<JTable, String> jTableBeanProperty_2 = BeanProperty.create("selectedElement.phone");
		BeanProperty<JTextField, String> jTextFieldBeanProperty_2 = BeanProperty.create("text");
		AutoBinding<JTable, String, JTextField, String> autoBinding_3 = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, m_personTable, jTableBeanProperty_2, m_phoneTextField, jTextFieldBeanProperty_2);
		autoBinding_3.bind();
		//
		BeanProperty<JTable, String> jTableBeanProperty_3 = BeanProperty.create("selectedElement.mobilePhone1");
		BeanProperty<JTextField, String> jTextFieldBeanProperty_3 = BeanProperty.create("text");
		AutoBinding<JTable, String, JTextField, String> autoBinding_4 = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, m_personTable, jTableBeanProperty_3, m_mobilePhone1TextField, jTextFieldBeanProperty_3);
		autoBinding_4.bind();
		//
		BeanProperty<JTable, String> jTableBeanProperty_4 = BeanProperty.create("selectedElement.mobilePhone2");
		BeanProperty<JTextField, String> jTextFieldBeanProperty_4 = BeanProperty.create("text");
		AutoBinding<JTable, String, JTextField, String> autoBinding_5 = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, m_personTable, jTableBeanProperty_4, m_mobilePhone2TextField, jTextFieldBeanProperty_4);
		autoBinding_5.bind();
		//
		ELProperty<JList, Object> jListEvalutionProperty = ELProperty.create("${ selectedElement != null }");
		BeanProperty<JButton, Boolean> jButtonBeanProperty = BeanProperty.create("enabled");
		AutoBinding<JList, Object, JButton, Boolean> autoBinding = Bindings.createAutoBinding(UpdateStrategy.READ, m_groupList, jListEvalutionProperty, m_editGroupButton, jButtonBeanProperty);
		autoBinding.bind();
		//
		...
		AutoBinding<JList, Object, JButton, Boolean> autoBinding_6 = Bindings.createAutoBinding(UpdateStrategy.READ, m_groupList, jListEvalutionProperty_1, m_deleteGroupButton, jButtonBeanProperty_1);
		autoBinding_6.bind();
		//
		...
		AutoBinding<JTable, Object, JButton, Boolean> autoBinding_7 = Bindings.createAutoBinding(UpdateStrategy.READ, m_personTable, jTableEvalutionProperty, m_deletePersonButton, jButtonBeanProperty_2);
		autoBinding_7.bind();
	}
}